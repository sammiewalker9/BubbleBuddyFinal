...
namespace CodeMonkey.Utils {
    ...
    public class Button_UI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler {
        ...
        private readonly Action internalOnPointerExitFunc;
        private Action internalOnPointerClickFunc;

        public Action InternalOnPointerExitFunc => InternalOnPointerExitFunc1;

        public Action InternalOnPointerExitFunc1 => internalOnPointerExitFunc;
